module Redis::Config
  ...
  class << self
    ...
    def base_config
      {
        url: ENV.fetch('REDIS_URL', 'redis://redis-14205.c74.us-east-1-4.ec2.redns.redis-cloud.com:14205'),
        password: ENV.fetch('REDIS_PASSWORD', 'qa9AHrtGGeqMbfGp1B5rqxJbulHXSr42').presence,
